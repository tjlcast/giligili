...
giligili: Simple Single Golang Web Service

go-crud正式改名为giligili!

使用giligili开发Web服务: 用最简单的架构，实现够用的框架，服务海量用户
...
giligili框架为移动端提供Token登录的案例: https://github.com/bydmm/giligili-token-exmaple
## 目的
